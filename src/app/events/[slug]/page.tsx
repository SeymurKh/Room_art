    ...
    <main>
      ...
      <section className="room-shell grid min-h-screen gap-12 pt-28 md:grid-cols-[.85fr_1.15fr]">
        <div>
          ...
          <Link href="/events" className="mt-10 inline-flex items-center gap-2 border-b border-black/20 pb-1 text-xs font-semibold uppercase tracking-[0.14em] transition hover:border-black/60">
